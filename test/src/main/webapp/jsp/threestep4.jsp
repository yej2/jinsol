...
<div>
    ...
    <div class="side1">
        ...
        <div class="ones">
            ...
            session.setAttribute("location2", location1);
            String location2 = (String) session.getAttribute("location2");
            
            String deeplocation1 = request.getParameter("deeplocation1");
            session.setAttribute("deeplocation2", deeplocation1);
    ...
    <div class="side2">
        ...
        <div class="box">
            ...
            <div class="box_three">
                <span>직업정보 </span><span>&ensp;<%=job2 %>&ensp;</span><button onclick="location='threefour.jsp'">직업선택</button>
            </div>
        </div>
        ...
        <div>이메일주소</div>
        <input type="text" name="id" placeholder="아이디" value="<%=id2 %>">
        <span>  @  </span>
        <input type="text" name="id" placeholder="아이디" value="<%=com2 %>">
        
        <div>우편물수령처</div>
        <button type="submit" >주소검색</button><span>&ensp;<input type="text" placeholder="주소입력" value="<%=location2 %>&ensp;<%=deeplocation2 %>"></span>
    ...
    <div><button class="top_margin">이전</button><button type="button" onClick="location='four.jsp'">다음 계약자 상세정보</button></div>    
