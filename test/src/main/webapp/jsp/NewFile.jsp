...
String formatChangeDay = todays.format(DateTimeFormatter.ofPattern("MM-dd"));
    ...
    <div class="side2">
        ...
        <div class="line"></div>
        <input id="afternow" type="text" name="afternow" value="3">
        ...
        <div class="ymd_color">
	        ...
	        <input name="i"  name="test" value="<jsp:setProperty name="ourDate" property="time" value="${ourDate.time + 94672800000}"/>
			<fmt:formatDate value="${ourDate}" pattern="yyyy.MM.dd"/>"/>
	        <span class="noblack">까지 보장해드립니다.</span>
        </div>
