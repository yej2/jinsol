...
<body>
<form id="gothreefive" method="post" action="threefive.jsp">
	<div>
...
<div class="full">
    ...
    <div class="side2">
        ...
        <div>우편물수령처</div>
        <button form="gothreefive" type="submit">주소검색</button></form><span>&ensp;<input type="text" placeholder="주소입력"></span>
